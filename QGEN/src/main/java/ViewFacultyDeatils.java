...
@WebServlet("/ViewFacultyDetails")
public class ViewFacultyDeatils extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("text/html");
        PrintWriter p = response.getWriter();
        Connection c = DBUtil.createconnection();
        String query = "SELECT * FROM addfacultybio";
        try {
            p.print("<!DOCTYPE html>\r\n"
                    ...
                    + "<link rel=\"stylesheet\" href=\"assets/css1/util.css\">\r\n"
                    ...
                    + "<th class=\"cell100 column4\">Degree</th>\r\n"
                    + "<th class=\"cell100 column5\">Phone No</th>\r\n"
                    + "</tr>\r\n"
                    + "</thead>\r\n"
                    + "</table>\r\n"
                    + "</div>\r\n"
